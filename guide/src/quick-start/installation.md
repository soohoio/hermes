...
Go to the [ibc-rs releases](https://github.com/soohoio/hermes/releases) page to see what is the most recent release.
...
This command builds all the crates from the [__`ibc-rs`__](https://github.com/soohoio/hermes) repository, namely: the [__`ibc-relayer`__](https://github.com/soohoio/hermes/tree/master/crates/relayer) crate, and the [__`ibc-relayer-cli`__](https://github.com/soohoio/hermes/tree/master/crates/relayer-cli) crate.
...
[releases]: https://github.com/soohoio/hermes/releases

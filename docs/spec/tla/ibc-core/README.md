...
[ICS3-Proto-1-ConnectionUniqueness](https://github.com/soohoio/hermes/blob/master/docs/spec/connection-handshake/L1_2.md#guarantees) A module accepts (i.e., initializes on) a connection end at most once.

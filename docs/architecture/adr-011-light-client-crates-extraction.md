...
in [ADR003 - Dealing with chain-specific datatypes](https://github.com/soohoio/hermes/blob/master/docs/architecture/adr-003-handler-implementation.md#dealing-with-chain-specific-datatypes)
->
...
[#2327](https://github.com/soohoio/hermes/pull/2327), but the solution seems to be fragile and unmaintainable.
...
* PRs for removing `Any*` enums:
    * Remove all occurences of Any* enums from light clients
      ([PR #2332](https://github.com/soohoio/hermes/pull/2332))
    * Remove Any* enums ([PR #2338](https://github.com/soohoio/hermes/pull/2338))
* Experimental PR for extracting `ibc-base` crate ([PR #2327](https://github.com/soohoio/hermes/pull/2327))
* Rationale behind design choice for `Any*` enums
  ([ADR003: Dealing with chain-specific datatypes](https://github.com/soohoio/hermes/blob/master/docs/architecture/adr-003-handler-implementation.md#dealing-with-chain-specific-datatypes))

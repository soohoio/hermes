...
* Optional flags for `upgrade clients`, issue [#2311](https://github.com/soohoio/hermes/issues/2311)
* Optional flags for `query connections`, issue [#2310](https://github.com/soohoio/hermes/issues/2310)
* Updating `query channel ends` to `query channel full`

The PR which updates the flags for all the commands as described in this ADR: [#2275](https://github.com/soohoio/hermes/pull/2275)
...
* Created a new PR, [#2384](https://github.com/soohoio/hermes/pull/2384), to add the optional flag for the `upgrade clients` command, issue [#2311](https://github.com/soohoio/hermes/issues/2311)

__11.07.22__

* Created a new PR, [#2391](https://github.com/soohoio/hermes/pull/2391), to add the optional flags for the `query connections` command, issue [#2310](https://github.com/soohoio/hermes/issues/2310)
...
* Proposal in issue: [#2239](https://github.com/soohoio/hermes/issues/2239)

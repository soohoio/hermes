...
([ADR](https://github.com/soohoio/hermes/blob/master/docs/architecture/README.md)).
...
```md
- [pkg] Some description about the change ([#xxx](https://github.com/soohoio/hermes/issues/xxx)) (optional @contributor)
```
...
9. Once the tag is pushed, wait for the CI bot to create a GitHub release, and update
   the release description to `[📖 CHANGELOG](https://github.com/soohoio/hermes/blob/master/CHANGELOG.md#vXYZ)`.
